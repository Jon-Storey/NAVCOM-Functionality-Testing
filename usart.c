...
void usart_init(void)
{
  ...
  USART0->ROUTELOC0 = USART_ROUTELOC0_RXLOC_LOC2 | USART_ROUTELOC0_TXLOC_LOC2;      //USART 1 - LOCATION 2 - IMU
  ...
  USART4->ROUTELOC0 = USART_ROUTELOC0_RXLOC_LOC0 | USART_ROUTELOC0_TXLOC_LOC0;      //USART 4 - LOCATION 0 - EXPANDER
  ...
  UART0->ROUTELOC0 = (USART_ROUTELOC0_TXLOC_LOC1 | USART_ROUTELOC0_RXLOC_LOC1);       //UART 0 - LOCATION 1 - FCPU
